...
argument-hint: "[--help]"
---
Execute the canonical control-plane prompt `.github/prompts/resume-ops-work.prompt.md` with arguments `$ARGUMENTS`. This command is a harness adapter (see `control-plane/framework/governance/harness/harness-adapters.md`) and carries no policy of its own.
