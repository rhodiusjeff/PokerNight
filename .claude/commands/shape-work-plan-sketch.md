...
---
Execute the canonical control-plane prompt `.github/prompts/shape-work-plan-sketch.prompt.md` with arguments `$ARGUMENTS`. This command is a harness adapter (see `control-plane/framework/governance/harness/harness-adapters.md`) and carries no policy of its own.
