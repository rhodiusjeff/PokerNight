...
<!-- Scaffolded into horizons/<HNNN-slug>/ledgers/SIDETRACK_TRACKER.md at horizon declaration.
     ...
     HORIZON-SCOPED (ST-H000-NNN); no instance-level sidetrack surface exists. -->
# Side-Track Tracker — H000
...
- `ST-H000-NNN` namespace; branch `sidetrack/ST-H000-NNN-<short-name>`.
- Side-track-local artifacts live under this packet's `sidetracks/ST-H000-NNN-<short-name>/`.
