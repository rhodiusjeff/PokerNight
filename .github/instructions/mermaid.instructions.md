...
For Mermaid diagrams, use the Mermaid VS Code extension workflow below. These rules do not
require a Mermaid copy of an Excalidraw or other provider's scene. For external diagram editing,
exports, or exact checkpoints, load `.github/skills/diagram-checkpoint/SKILL.md` and honor the
selected provider. Preserve the existing Mermaid Chart Sync workflow for managed Mermaid files.
...
## LM Tools — call these for every Mermaid diagram interaction
